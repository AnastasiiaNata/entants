		...
		<div v-cloak>
			<div class="container">
				...
				<div class="row mt-5">
					...
					<div col-6>
						<a href="{{ route('addEntant') }}"><button class="btn btn-success btn-rounded ml-5">
							...
							<tbody>
								...
								@foreach($answer as $ans)
									<tr>
			      						...
			      						<td>		      						
			      							<a href="{{ route('editMainEntant', ['id_entant' => $ans->entant_id]) }}"><button class="btn btn-warning btn-rounded btn-xs">Ред.</button></a>
