	...
	<div class="container">
		<div v-cloak>
			...
			<div class="row mt-5">
				<div class="col-4"></div>
				<div class = "col-6">
					<a href="{{ route('showEntants') }}"> <button class="btn btn-primary btn-rounded mt-5" href="{{ route('showEntants') }}">
		    ...
		    <div class="row">
		    	<div class="col-4"></div>
		        <div class = "col-6">
					<a href="{{ route('subjects', ['direct' => 0]) }}"> <button class="btn btn-primary btn-rounded mt-5">
